...
tsf::INI::File::File (wchar_t* filename)
{
  sections.clear ();
...
bool
Import_Section (tsf::INI::File::Section& section, wchar_t* buffer, int start, int end)
{
  int key = start;
  for (int k = key; k < end; k++) {
    if (k < end - 1 && buffer [k] == L'=') {
...
void
tsf::INI::File::import (std::wstring import_data)
{
...
std::wstring&
tsf::INI::File::Section::get_value (std::wstring key)
{
...
bool
tsf::INI::File::Section::contains_key (std::wstring key)
{
...
void
tsf::INI::File::Section::add_key_value (std::wstring key, std::wstring value)
{
...
bool
tsf::INI::File::contains_section (std::wstring section)
{
  return sections.find (section) != sections.end ();
}

tsf::INI::File::Section&
tsf::INI::File::get_section (std::wstring section)
{
...
void
tsf::INI::File::write (std::wstring fname)
{
  FILE*   fOut;
  errno_t ret;
...
const std::map <std::wstring, tsf::INI::File::Section>&
tsf::INI::File::get_sections (void)
{
  return sections;
}