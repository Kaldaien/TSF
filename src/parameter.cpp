...
std::wstring
tsf::ParameterInt::get_value_str (void)
{
  wchar_t str [32];
  _itow (value, str, 10);
...
int
tsf::ParameterInt::get_value (void)
{
  return value;
}

void
tsf::ParameterInt::set_value (int val)
{
  value = val;
}
...
void
tsf::ParameterInt::set_value_str (std::wstring str)
{
...
int64_t
tsf::ParameterInt64::get_value (void)
{
  return value;
}

void
tsf::ParameterInt64::set_value (int64_t val)
{
  value = val;
}
...
std::wstring
tsf::ParameterBool::get_value_str (void)
{
  if (value == true)
    return L"true";
...
bool
tsf::ParameterBool::get_value (void)
{
  return value;
}

void
tsf::ParameterBool::set_value (bool val)
{
  value = val;
}
...
void
tsf::ParameterBool::set_value_str (std::wstring str)
{
  if (str.length () == 1 &&
      str [0] == L'1')
    value = true;
...
float
tsf::ParameterFloat::get_value (void)
{
  return value;
}

void
tsf::ParameterFloat::set_value (float val)
{
  value = val;
}
...
void
tsf::ParameterFloat::set_value_str (std::wstring str)
{
...
std::wstring
tsf::ParameterStringW::get_value (void)
{
  return value;
}

void
tsf::ParameterStringW::set_value (std::wstring val)
{
  value = val;
}
...
template <>
tsf::iParameter*
tsf::ParameterFactory::create_parameter <int> (const wchar_t* name)
{
...
template <>
tsf::iParameter*
tsf::ParameterFactory::create_parameter <int64_t> (const wchar_t* name)
{
...
template <>
tsf::iParameter*
tsf::ParameterFactory::create_parameter <bool> (const wchar_t* name)
{
...
template <>
tsf::iParameter*
tsf::ParameterFactory::create_parameter <float> (const wchar_t* name)
{
...
template <>
tsf::iParameter*
tsf::ParameterFactory::create_parameter <std::wstring> (const wchar_t* name)
{
